...
import pycebes.core.functions as functions
...
class Column(object):
    ...
    def _bin_op(self, expr_class, other):
        ...
        """
        return Column(expr_class(self.expr, functions.lit(other).expr))
    ...
    def when(self, condition, value):
        ...
        return Column(exprs.CaseWhen(self.expr[:] + [(condition, functions.lit(value).expr)]))
    ...
    def otherwise(self, value):
        ...
        return Column(exprs.CaseWhen(self.expr[:], functions.lit(value).expr))
    ...
    def isin(self, values):
        ...
        """
        return self._with_expr(exprs.In, [functions.lit(v) for v in values])
    ...
    def substr(self, start_pos, length):
        ...
        """
        return self._with_expr(exprs.Substring, functions.lit(start_pos).expr, functions.lit(length).expr)
    ...
    def alias(self, *alias):
        ...
        """
        if len(alias) == 1:
            return self._bin_op(exprs.Alias, alias)
        return self._bin_op(exprs.MultiAlias, alias)
